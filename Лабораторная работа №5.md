...
- network_settings:  
  ...
  Вывод:
    - В связи с тем, что узлов в каждом скрытом слое 32, уменьшилось время обучения, но и точность обучения из-за этого тоже страдает. Очень сильно скачает ошибка обучения (Value Loss), очень не стабильно. В остальном графики +- одинаковы. Но при 512 узлов в скрытом слое существенно увеличивается время обучения. На 20000 мы имеем Mean Rewards = -1.  Оценка внешней ценности (Extrinsic value estimate) начинает уменьшатьсяс 20000 в отличие от hidden_units = 32.
