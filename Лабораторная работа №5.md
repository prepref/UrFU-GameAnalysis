...
- network_settings:  
  ...
  Вывод:
    - Появляется ошибка обучения, которая в процессе,конечно, уменьшается, а также в связи с тем, что узлов в каждом скрытом слое 32, уменьшилось время обучения, но и точность обучения из-за этого тоже страдает. Очень сильно скачает ошибка обучения (Value Loss), очень не стабильно. В остальном графики +- одинаковы.
  ...
  Вывод:
    - Так как всего один скрытый слой, то в начале ошибка обучения будет максимальной, но в процессе обучения ошибка будет стремится к 0. Время обучения тоже немного сократилось. Дополнительные вознаграждения (Extrinsic Rewards) растут экспотенциально. В остальном графики +- похожи.  
